var htmx = (function () {
  ...
  function dt(t, n, e) {
    if (
      (t instanceof HTMLAnchorElement && at(t) && (t.target === '' || t.target === '_self')) ||
  ...
  function mn(e) {
    return (
      re(e, 'hx-encoding') === 'multipart/form-data' || (f(e, 'form') && ee(e, 'enctype') === 'multipart/form-data')
    );
  }
  function yn(t, n, r) {
    let o = null;
  ...
  function Hn(e, t, n) {
    ...
    if (n) {
      if (n instanceof Element || typeof n === 'string') {
        return he(e, t, null, null, { targetOverride: y(n), returnPromise: true });
      } else {
  ...
  function he(t, n, r, o, i, D) {
    ...
    if (D === undefined) {
      ...
      const G = { target: u, elt: r, path: n, verb: t, triggeringEvent: o, etc: i, issueRequest: K, question: f };
  ...
  function Mn(o, i) {
    ...
    var p = s.response;
    var m = ue({ shouldSwap: a, serverResponse: p, isError: f, ignoreTitle: d, selectOverride: h }, i);
    ...
    if (f) {
      fe(
        o,
        'htmx:responseError',
        ue({ error: 'Response Status Error Code ' + s.status + ' from ' + i.pathInfo.requestPath }, i),
      );
    }
  }
  const Xn = {};
